...
class Device {
  static double devicePixelRatio = ui.PlatformDispatcher.instance.views.first.devicePixelRatio;
  static ui.Size size = ui.PlatformDispatcher.instance.views.first.physicalSize;
  ...
  factory Device.get() {
    ...
    if (onMetricsChange == null) {
      ...
      ui.PlatformDispatcher.instance.onMetricsChanged = () {
        _device = null;
        size = ui.PlatformDispatcher.instance.views.first.physicalSize;
        width = size.width;
        height = size.height;
  ...
  static double _calWidth() {
    if (width > height) {
      return (width + (ui.PlatformDispatcher.instance.views.first.viewPadding.left + ui.PlatformDispatcher.instance.views.first.viewPadding.right) * width / height);
    }
  ...
  static bool _hasTopOrBottomPadding() {
    final padding = ui.PlatformDispatcher.instance.views.first.viewPadding;
    //print(padding);
