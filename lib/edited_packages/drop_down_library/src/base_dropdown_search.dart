...
import 'package:oda/edited_packages/drop_down_library/src/popups/autocomplete_overlay.dart';
import 'package:oda/edited_packages/drop_down_library/src/popups/bottom_sheets.dart';
import 'package:oda/edited_packages/drop_down_library/src/popups/dialogs.dart';
import 'package:oda/edited_packages/drop_down_library/src/popups/menu.dart';
import 'package:oda/edited_packages/drop_down_library/src/popups/modal_bottom_sheet.dart';
...
import 'package:oda/edited_packages/drop_down_library/src/widgets/custom_icon_button.dart';
import 'package:oda/edited_packages/drop_down_library/src/widgets/custom_inkwell.dart';
...
class DropdownSearchState<T> extends State<BaseDropdownSearch<T>> {
  ...
  Widget? _buildSelectedItemsWidget() {
    Widget? defaultSelectedItems(List<T> items) {
      ...
      return CustomSingleScrollView(
        scrollProps: widget.selectedItemsScrollProps ?? const ScrollProps(),
        child: CustomWrap(
            ...
            return CustomChip(
              ...
              props: ChipProps(
                ...
                deleteIcon: _uiToApply == UiToApply.cupertino
                    ? const Icon(CupertinoIcons.multiply_circle_fill)
                    : null,
  ...
  Widget _customField() => _buildSelectedItemsWidget() ?? const SizedBox.shrink();
  ...
  InputDecoration _manageDropdownDecoration(FormFieldState state) {
    const cupertinoBorder = OutlineInputBorder(
      borderRadius: kCupertinoBorderRadius,
      borderSide: kCupertinoBorderSide,
    );

    const cupertinoDecoration = InputDecoration(
    ...
    const materialDefaultDecoration = InputDecoration(
        ...
        isMultiSelectionMode
            ? [
                CupertinoActionSheetAction(
                    onPressed: () => popupOnValidate(), child: const Text('OK'))
              ]
            : null,
      );
    }
