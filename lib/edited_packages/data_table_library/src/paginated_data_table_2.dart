...
class PaginatedDataTable2State extends State<PaginatedDataTable2> {
  ...
  Widget _getFooter() {
    ...
    if (widget.onRowsPerPageChanged != null) {
      final List<Widget> availableRowsPerPage = widget.availableRowsPerPage.where((int value) => value <= _rowCount || value == _effectiveRowsPerPage).map<DropdownMenuItem<int>>((int value) {
