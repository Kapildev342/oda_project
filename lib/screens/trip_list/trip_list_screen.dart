...
class TripListScreen extends StatefulWidget {
  static const String id = "trip_list_screen";
...
class _TripListScreenState extends State<TripListScreen> {
  ...
  @override
  void initState() {
    context.read<TripListBloc>().tripListEmpty = [
      TripList(
          tripId: "1234",
          tripNum: "12345",
          tripVehicle: "1234",
    ...
    context.read<TripListBloc>().add(const TripListInitialEvent(isInitial: true));
            ...
            child: Column(
              ...
              children: <Widget>[
                BlocBuilder<TripListBloc, TripListState>(
                  builder: (BuildContext context, TripListState tripList) {
                    return SizedBox(
                      ...
                      child: AppBar(
                          ...
                          children: [
                            Expanded(
                              child: SingleChildScrollView(
                                ...
                                child: Text(
                                  getIt<Variables>().generalVariables.currentLanguage.sortingTripLists,
                                  style: TextStyle(
                                      fontWeight: FontWeight.w700,
                        ...
                        actions: [
                          AnimatedCrossFade(
                            ...
                            crossFadeState: context.read<TripListBloc>().searchBarEnabled ? CrossFadeState.showSecond : CrossFadeState.showFirst,
                                ...
                                InkWell(
                                  onTap: tripList is TripListLoading || tripList is TripListTableLoading
                                      ...
                                      : () {
                                          ...
                                          context.read<TripListBloc>().currentListIndex = 1;
                                          context.read<TripListBloc>().add(const TripListFilterEvent());
                                        },
                                  child: context.read<TripListBloc>().currentListIndex == 1
                                      ? Container(
                                          height: getIt<Functions>().getWidgetHeight(height: 29),
                                          width: getIt<Functions>().getWidgetWidth(width: 28),
                                          margin: EdgeInsets.only(
                                ...
                                InkWell(
                                  onTap: tripList is TripListLoading || tripList is TripListTableLoading
                                      ...
                                      : () {
                                          ...
                                          context.read<TripListBloc>().currentListIndex = 2;
                                          context.read<TripListBloc>().add(const TripListFilterEvent());
                                        },
                                  child: context.read<TripListBloc>().currentListIndex == 2
                                      ? Container(
                                          height: getIt<Functions>().getWidgetHeight(height: 29),
                                          width: getIt<Functions>().getWidgetWidth(width: 28),
                                          margin: EdgeInsets.only(
                          ...
                          InkWell(
                            onTap: tripList is TripListLoading || tripList is TripListTableLoading
                                ? () {}
                                : () {
                                    context.read<TripListBloc>().searchBarEnabled = !context.read<TripListBloc>().searchBarEnabled;
                                    if (!context.read<TripListBloc>().searchBarEnabled) {
                                      searchBar.clear();
                                      FocusManager.instance.primaryFocus!.unfocus();
                                      context.read<TripListBloc>().searchText = "";
                                    }
                                    context.read<TripListBloc>().add(const TripListFilterEvent());
                                  },
                            child: Container(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: BlocConsumer<TripListBloc, TripListState>(
                      buildWhen: (TripListState previous, TripListState current) {
                        return previous != current;
                      },
                      listenWhen: (TripListState previous, TripListState current) {
                        return previous != current;
                      },
                      listener: (BuildContext context, TripListState state) {
                      ...
                      builder: (BuildContext context, TripListState state) {
                        if (state is TripListLoading) {
                          return Skeletonizer(
                            ...
                            child: SfDataGridTheme(
                              ...
                              child: SfDataGrid(
                                source: TripListScreenDataSource(context.read<TripListBloc>().tripListEmpty, dataGridController, context),
                                ...
                                onCellTap: (details) {
                                  getIt<Variables>().generalVariables.indexName = TripListEntryScreen.id;
                                  getIt<Variables>().generalVariables.tripListRouteList.add(TripListScreen.id);
                                  context.read<NavigationBloc>().add(const NavigationInitialEvent());
                                },
                        ...
                        } else if (state is TripListTableLoading) {
                          ...
                          return context.read<TripListBloc>().isDataNotAvailable
                              ? Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    Padding(
                                      padding: EdgeInsets.symmetric(horizontal: getIt<Functions>().getWidgetWidth(width: 50.0)),
                                      child: Text(
                                        "Trip List data not available due to non available of Internet",
                                        textAlign: TextAlign.center,
                                        style: TextStyle(fontSize: getIt<Functions>().getTextSize(fontSize: 26), fontWeight: FontWeight.w600),
                                      ),
                                    ),
                                  ],
                                )
                              : Stack(
                                  ...
                                  children: [
                                    SfDataGridTheme(
                                      ...
                                      child: SfDataGrid(
                                        source: TripListScreenDataSource(context.read<TripListBloc>().searchedTripList, dataGridController, context),
                                        columnWidthMode: ColumnWidthMode.fill,
                                        controller: dataGridController,
                                        columns: getColumns,
                                        gridLinesVisibility: GridLinesVisibility.horizontal,
                                        ...
                                        onCellTap: (details) {
                                          getIt<Variables>().generalVariables.tripListMainIdData =
                                              context.read<TripListBloc>().searchedTripList[details.rowColumnIndex.rowIndex - 1];
                                          getIt<Variables>().generalVariables.indexName = TripListEntryScreen.id;
                                          getIt<Variables>().generalVariables.tripListRouteList.add(TripListScreen.id);
                                          context.read<NavigationBloc>().add(const NavigationInitialEvent());
                                        },
                                    ...
                                    context.read<TripListBloc>().searchedTripList.isEmpty
                                        ? Column(
                                            mainAxisAlignment: MainAxisAlignment.center,
                                            crossAxisAlignment: CrossAxisAlignment.center,
                                            children: [
                          ...
                          actions: [
                            ...
                            SizedBox(
                              ...
                              child: PageView.builder(
                                ...
                                onPageChanged: tripList is TripListLoading || tripList is TripListTableLoading
                                    ? (value) {}
                                    : (value) {
                                        getIt<Variables>().generalVariables.currentBackGround =
                                            getIt<Variables>().generalVariables.backGroundChangesList[value];
                                        context.read<TripListBloc>().currentListIndex = value;
                                        context.read<TripListBloc>().add(const TripListFilterEvent());
                                      },
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      "Trip List data not available due to non available of Internet",
                                      textAlign: TextAlign.center,
                                      style: TextStyle(fontSize: getIt<Functions>().getTextSize(fontSize: 14), fontWeight: FontWeight.w600),
                                    ),
                                  ),
                                  SizedBox(height: getIt<Functions>().getWidgetHeight(height: 8)),
                                  ElevatedButton(
                                      onPressed: () async {
                                        context.read<TripListBloc>().offlineCsvData.clear();
                                        context.read<TripListBloc>().offlineCsvData = await getIt<Functions>().convertingCSVToList();
                                        if (context.mounted) {
                                          context.read<TripListBloc>().add(const CsvUploadEvent());
                                        }
                                      },
          ...
          child: Column(
            ...
            children: [
              SizedBox(
                ...
                child: TextFormField(
                  onChanged: (value) {
                    context.read<TripListBloc>().add(const TripListSetStateEvent());
                    if (timer?.isActive ?? false) timer?.cancel();
                    timer = Timer(const Duration(milliseconds: 500), () {
                      if (value.isNotEmpty) {
                        context.read<TripListBloc>().searchText = value;
                        context.read<TripListBloc>().add(const TripListFilterEvent());
                      } else {
                        FocusManager.instance.primaryFocus!.unfocus();
                        context.read<TripListBloc>().searchText = "";
...
class TripListScreenDataSource extends DataGridSource {
  TripListScreenDataSource(List<TripList> tripList, this.dataGridController, this.context) {
    ...
    return DataGridRowAdapter(
      ...
      if (e.columnName == 'tripId') {
        return BlocBuilder<TripListBloc, TripListState>(
          builder: (BuildContext context, TripListState state) {
            return Skeletonizer(
              enabled: state is TripListTableLoading || state is TripListLoading,
              child: Container(
                  ...
                  children: [
                    ...
                    Skeleton.shade(
                      child: Container(
                        ...
                        child: Text(
                          e.value[1].toString().toUpperCase(),
                          style: TextStyle(
                              color: const Color(0xffFFFFFF),
                              fontWeight: FontWeight.w600,
      ...
      if (e.columnName == 'handled') {
        return BlocBuilder<TripListBloc, TripListState>(builder: (BuildContext context, TripListState state) {
  ...
  Future<void> handleRefresh() async {
    context.read<TripListBloc>().tripListEmpty.clear();
    context.read<TripListBloc>().tripListEmpty = [
      TripList(
          tripId: "1234",
          tripNum: "12345",
    ...
    context.read<TripListBloc>().add(const TripListInitialEvent(isInitial: false));
  }

  @override
  Future<void> handleLoadMoreRows() async {
    context.read<TripListBloc>().tripListEmpty.addAll([]);
    context.read<TripListBloc>().add(const TripListSetStateEvent());
  }
}
