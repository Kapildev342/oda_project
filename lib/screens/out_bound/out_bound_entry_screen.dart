...
bool? isOutBoundEntryHeaderCheckboxState = false;

class OutBoundEntryScreen extends StatefulWidget {
  static const String id = "out_bound_entry_screen";
...
class _OutBoundEntryScreenState extends State<OutBoundEntryScreen> {
  ...
  @override
  void initState() {
    context.read<OutBoundEntryBloc>().soListDummy = [
      SoList(
          soId: "10363",
          soNum: "24439633",
    ...
    context.read<OutBoundEntryBloc>().add(const OutBoundEntryTimeLineEvent());
    context.read<OutBoundEntryBloc>().add(const OutBoundEntryInitialEvent());
    super.initState();
  }
            ...
            child: Row(
              ...
              children: [
                Checkbox(
                    ...
                    value: context.read<OutBoundEntryBloc>().isAllSelected,
                    onChanged: (value) {
                      if (value!) {
                        context.read<OutBoundEntryBloc>().isAllSelected = true;
                        context.read<OutBoundEntryBloc>().selectedSoList.clear();
                        for (int i = 0; i < context.read<OutBoundEntryBloc>().searchedSoList.length; i++) {
                          context.read<OutBoundEntryBloc>().searchedSoList[i].isSelected = true;
                        }
                        context.read<OutBoundEntryBloc>().selectedSoList.addAll(context.read<OutBoundEntryBloc>().searchedSoList);
                        context.read<OutBoundEntryBloc>().add(const OutBoundEntrySetStateEvent());
                      } else {
                        context.read<OutBoundEntryBloc>().isAllSelected = false;
                        for (int i = 0; i < context.read<OutBoundEntryBloc>().searchedSoList.length; i++) {
                          context.read<OutBoundEntryBloc>().searchedSoList[i].isSelected = false;
                        }
                        context.read<OutBoundEntryBloc>().selectedSoList.clear();
                        context.read<OutBoundEntryBloc>().add(const OutBoundEntrySetStateEvent());
                      }
        ...
        if (constraints.maxWidth > 480) {
          return Container(
            ...
            child: Column(
              mainAxisAlignment: MainAxisAlignment.start,
              children: <Widget>[
                BlocBuilder<OutBoundEntryBloc, OutBoundEntryState>(
                  builder: (BuildContext context, OutBoundEntryState state) {
                    return SizedBox(
                      ...
                      child: AppBar(
                          ...
                          children: [
                            Expanded(
                              child: SingleChildScrollView(
                                ...
                                child: Text(
                                  "${getIt<Variables>().generalVariables.currentLanguage.outBoundTripLists} # ${getIt<Variables>().generalVariables.tripListMainIdData.tripNum}",
                                  style: TextStyle(
                        ...
                        actions: [
                          AnimatedCrossFade(
                            ...
                            crossFadeState: context.read<OutBoundEntryBloc>().searchBarEnabled ? CrossFadeState.showSecond : CrossFadeState.showFirst,
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: state is OutBoundEntryLoading || state is OutBoundEntryTableLoading
                                      ? () {}
                                      : () {
                                          getIt<Variables>().generalVariables.currentBackGround =
                                              getIt<Variables>().generalVariables.backGroundChangesList[0];
                                          context.read<OutBoundEntryBloc>().currentListIndex = 0;
                                          context.read<OutBoundEntryBloc>().add(const OutBoundEntryFilterEvent());
                                        },
                                  child: context.read<OutBoundEntryBloc>().currentListIndex == 0
                                      ? Container(
                                ...
                                InkWell(
                                  onTap: state is OutBoundEntryLoading || state is OutBoundEntryTableLoading
                                      ...
                                      : () {
                                          ...
                                          context.read<OutBoundEntryBloc>().currentListIndex = 1;
                                          context.read<OutBoundEntryBloc>().add(const OutBoundEntryFilterEvent());
                                        },
                                  child: context.read<OutBoundEntryBloc>().currentListIndex == 1
                                      ? Container(
                                          height: getIt<Functions>().getWidgetHeight(height: 29),
                                          width: getIt<Functions>().getWidgetWidth(width: 28),
                                          margin: EdgeInsets.only(
                                ...
                                InkWell(
                                  onTap: state is OutBoundEntryLoading || state is OutBoundEntryTableLoading
                                      ...
                                      : () {
                                          ...
                                          context.read<OutBoundEntryBloc>().currentListIndex = 2;
                                          context.read<OutBoundEntryBloc>().add(const OutBoundEntryFilterEvent());
                                        },
                                  child: context.read<OutBoundEntryBloc>().currentListIndex == 2
                                      ? Container(
                                          height: getIt<Functions>().getWidgetHeight(height: 29),
                                          width: getIt<Functions>().getWidgetWidth(width: 28),
                                          margin: EdgeInsets.only(
                          ...
                          InkWell(
                            onTap: state is OutBoundEntryLoading || state is OutBoundEntryTableLoading
                                ? () {}
                                : () {
                                    context.read<OutBoundEntryBloc>().searchBarEnabled = !context.read<OutBoundEntryBloc>().searchBarEnabled;
                                    if (!context.read<OutBoundEntryBloc>().searchBarEnabled) {
                                      searchBar.clear();
                                      FocusManager.instance.primaryFocus!.unfocus();
                                      context.read<OutBoundEntryBloc>().searchText = "";
                                    }
                                    context.read<OutBoundEntryBloc>().add(const OutBoundEntryFilterEvent());
                                  },
                            child: Container(
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: BlocConsumer<OutBoundEntryBloc, OutBoundEntryState>(
                      listenWhen: (OutBoundEntryState previous, OutBoundEntryState current) {
                        return previous != current;
                      },
                      buildWhen: (OutBoundEntryState previous, OutBoundEntryState current) {
                        return previous != current;
                      },
                      listener: (BuildContext context, OutBoundEntryState state) {},
                      builder: (BuildContext context, OutBoundEntryState state) {
                        if (state is OutBoundEntryLoading) {
                          return Skeletonizer(
                            enabled: true,
                            child: SfDataGridTheme(
                              ...
                              child: SfDataGrid(
                                source: TripListDataSource(context.read<OutBoundEntryBloc>().soListDummy, dataGridController, context),
                        ...
                        } else if (state is OutBoundEntryTableLoading) {
                        ...
                        } else if (state is OutBoundEntryLoaded) {
                          return Stack(
                            alignment: Alignment.center,
                            children: [
                              SfDataGridTheme(
                                data: const SfDataGridThemeData(
                                    headerColor: Colors.transparent, gridLineColor: Colors.transparent, selectionColor: Colors.transparent),
                                child: SfDataGrid(
                                  source: TripListDataSource(context.read<OutBoundEntryBloc>().searchedSoList, dataGridController, context),
                                  columnWidthMode: ColumnWidthMode.fill,
                                  controller: dataGridController,
                                  columns: getColumns,
                                  gridLinesVisibility: GridLinesVisibility.horizontal,
                                  ...
                                  selectionMode: SelectionMode.multiple,
                                  onCellTap: (details) {
                                    context.read<OutBoundEntryBloc>().searchedSoList[details.rowColumnIndex.rowIndex - 1].isSelected = true;
                                    context
                                        .read<OutBoundEntryBloc>()
                                        .selectedSoList
                                        .add(context.read<OutBoundEntryBloc>().searchedSoList[details.rowColumnIndex.rowIndex - 1]);
                                    getIt<Variables>().generalVariables.indexName = OutBoundDetailScreen.id;
                                    getIt<Variables>().generalVariables.outBoundRouteList.add(OutBoundEntryScreen.id);
                                    context.read<NavigationBloc>().add(const NavigationInitialEvent());
                                  },
                                  allowPullToRefresh: true,
                                  loadMoreViewBuilder: (context, loadMoreRows) {
                              ...
                              context.read<OutBoundEntryBloc>().searchedSoList.isEmpty
                                  ? Column(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: [
                ...
                BlocBuilder<OutBoundEntryBloc, OutBoundEntryState>(
                  builder: (BuildContext context, OutBoundEntryState state) {
                    if (state is OutBoundEntryLoaded) {
                      return Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          SizedBox(
                            height: getIt<Functions>().getWidgetHeight(height: context.read<OutBoundEntryBloc>().selectedSoList.isNotEmpty ? 15 : 0),
                          ),
                          context.read<OutBoundEntryBloc>().selectedSoList.isNotEmpty
                              ? Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
          ...
          return Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                        ...
                        actions: [
                          SizedBox(
                            ...
                            child: PageView.builder(
                              ...
                              onPageChanged: state is OutBoundEntryLoading || state is OutBoundEntryTableLoading
                                  ? (value) {}
                                  : (value) {
                                      getIt<Variables>().generalVariables.currentBackGround =
                                          getIt<Variables>().generalVariables.backGroundChangesList[value];
                                      context.read<OutBoundEntryBloc>().currentListIndex = value;
                                      context.read<OutBoundEntryBloc>().add(const OutBoundEntryFilterEvent());
                                    },
                ...
                Expanded(
                  child: Padding(
                    padding: EdgeInsets.symmetric(vertical: getIt<Functions>().getWidgetWidth(width: 30)),
                    child: BlocConsumer<OutBoundEntryBloc, OutBoundEntryState>(
                      listenWhen: (OutBoundEntryState previous, OutBoundEntryState current) {
                        return previous != current;
                      },
                ...
                BlocBuilder<OutBoundEntryBloc, OutBoundEntryState>(builder: (BuildContext context, OutBoundEntryState state) {
                  if (state is OutBoundEntryLoaded) {
                    return Column(
                      children: [
                        context.read<OutBoundEntryBloc>().selectedSoList.isNotEmpty
  ...
  Widget textBars({required TextEditingController controller}) {
    return BlocBuilder<OutBoundEntryBloc, OutBoundEntryState>(
      builder: (BuildContext context, OutBoundEntryState tripList) {
        return SizedBox(
                ...
                child: TextFormField(
                  onChanged: (value) {
                    ...
                    timer = Timer(const Duration(milliseconds: 500), () {
                      if (value.isNotEmpty) {
                        context.read<OutBoundEntryBloc>().searchText = value;
                        context.read<OutBoundEntryBloc>().add(const OutBoundEntryFilterEvent());
                      } else {
                        FocusManager.instance.primaryFocus!.unfocus();
                        context.read<OutBoundEntryBloc>().searchText = "";
...
class TripListDataSource extends DataGridSource {
  ...
  void buildDataGridRows(List<SoList> tripList) {
    dataGridRows = tripList
        .map<DataGridRow>((e) => DataGridRow(cells: [
              ...
              DataGridCell(columnName: 'NoOfItems', value: ['${e.soNoOfLoadedItems}/${e.soNoOfItems}']),
    ...
    return DataGridRowAdapter(
      ...
      if (e.columnName == 'SalesOrder') {
        ...
        return BlocBuilder<OutBoundEntryBloc, OutBoundEntryState>(
          builder: (BuildContext context, OutBoundEntryState state) {
            return Skeletonizer(
              enabled: state is OutBoundEntryTableLoading || state is OutBoundEntryLoading,
              child: Container(
                      ...
                      child: Checkbox(
                          ...
                          onChanged: (value) {
                            if (value!) {
                              ...
                              context.read<OutBoundEntryBloc>().selectedSoList.add(dataValue);
                              context.read<OutBoundEntryBloc>().add(const OutBoundEntrySetStateEvent());
                            } else {
                              dataValue.isSelected = false;
                              int index = context.read<OutBoundEntryBloc>().selectedSoList.indexWhere((e) => e.soNum == dataValue.soNum);
                              context.read<OutBoundEntryBloc>().selectedSoList.removeAt(index);
                              context.read<OutBoundEntryBloc>().add(const OutBoundEntrySetStateEvent());
                            }
                            if (context.read<OutBoundEntryBloc>().selectedSoList.length == context.read<OutBoundEntryBloc>().searchedSoList.length) {
                              context.read<OutBoundEntryBloc>().isAllSelected = true;
                            } else {
                              context.read<OutBoundEntryBloc>().isAllSelected = false;
                            }
      ...
      if (e.columnName == 'Handled') {
        ...
        return BlocBuilder<OutBoundEntryBloc, OutBoundEntryState>(builder: (BuildContext context, OutBoundEntryState state) {
  ...
  Widget usersDetailsContent({required List<HandledByForUpdateList> handled}) {
    return BlocConsumer<OutBoundEntryBloc, OutBoundEntryState>(
      listenWhen: (OutBoundEntryState previous, OutBoundEntryState current) {
        return previous != current;
      },
      buildWhen: (OutBoundEntryState previous, OutBoundEntryState current) {
  ...
  Future<void> handleRefresh() async {
    context.read<OutBoundEntryBloc>().isAllSelected = context.read<OutBoundEntryBloc>().selectedSoList.length == context.read<OutBoundEntryBloc>().searchedSoList.length;
    context.read<OutBoundEntryBloc>().add(const OutBoundEntrySetStateEvent());
  }

  @override
  Future<void> handleLoadMoreRows() async {
    context.read<OutBoundEntryBloc>().isAllSelected =
        context.read<OutBoundEntryBloc>().selectedSoList.length == context.read<OutBoundEntryBloc>().searchedSoList.length;
    context.read<OutBoundEntryBloc>().add(const OutBoundEntrySetStateEvent());
  }
